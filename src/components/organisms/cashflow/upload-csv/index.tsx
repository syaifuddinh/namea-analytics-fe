...
export default function UploadCSV({
	...
	return (
		<div
			className={"upload-csv lg:flex-row md:flex-col flex lg:items-center justify-between gap-4 rounded-[16px] p-5 " + className}
		>
			...
			<div className="upload-csv_hall flex items-center">
				...
				<div className="upload-csv_divider w-[1px] h-[24px] bg-[var(--Gray1)]"></div> 

				<UploadButton label="Upload CSV File" className="ml-6" />
			</div>
		</div>
	)
}