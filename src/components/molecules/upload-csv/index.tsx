	...
	return (
		...
		>
			<div className="upload-csv_entry">
				...
				<div className="upload-csv_description mt-1 font-extralight text-sm leading-5 text-[var(--Gray6)]">
			...
			<div className="upload-csv_hall flex flex-col sm:flex-row items-start sm:items-center">
				<div className="upload-csv_last-update font-extralight text-sm leading-5 text-[var(--Gray6)] mr-[1.5rem]">
